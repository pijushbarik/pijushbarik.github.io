...
description: "Getting started with my homelab setup and documentation. Setting up hardware, OS and Docker."
tags:
  - homelab
  - selfhosted
  - linux
...
For OS, I decided to go with Ubuntu Server 24.04.03 LTS. Created the bootable Ubuntu USB with [Balena Etcher](https://etcher.balena.io/) from my Mac. I won't go into details about how to install Ubuntu Server; there are a lot of guides available on the internet. But here is the disk partition size I decided to go with.
