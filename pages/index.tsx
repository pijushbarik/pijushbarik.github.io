          ...
          <div className="flex flex-col md:flex-row space-y-10 md:space-y-0 space-x-0 md:space-x-10">
            ...
            <div className="w-full md:w-8/12 leading-snug text-2xl">
              ...
              <p className="mt-12">
                ...
                Masters in CS and played with many languages and technologies
                till now.
              </p>
              ...
              <li className={styles.experienceList_item}>
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="leading-tight max-w-5xl">
                    ...
                    Developing feature-rich web application on NextJS and AntD.
                    Managing and developing backend APIs with Strapi.
                  </span>
                </div>
              </li>
              ...
              <li className={styles.experienceList_item}>
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="leading-tight">
                    ...
                    application with C++, CUDA and OpenCV. Creating build tools
                    with CMAKE for easy code compilation.
                  </span>
                </div>
              </li>
              ...
              <li className={styles.experienceList_item}>
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="leading-tight">
                    ...
                    Worked with OpenCV for image processing. Developing product
                    showcase website.
                  </span>
                </div>
              </li>
