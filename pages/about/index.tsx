...
const AboutPage = () => {
  return (
    <>
      <Container fluid className="flex flex-wrap mt-10">
        <div className="w-full mb-8">
          <h1 className="text-7xl block w-max-content mx-auto sm:mx-0 capitalize font-serif font-bold left-outline">
            <span>about me.</span>
          </h1>
        </div>
        ...
        <div
          className="w-full sm:w-7/12 md:w-6/12 lg:w-5/12 text-xl mt-5 \
        ...
        >
          ...
          <p className="mt-12">
            ...
            <strong>real time image processing with NVIDIA GPUs</strong>. I have
            written codes in <strong>C++</strong> &amp; <strong>CUDA</strong>.
            Implemented cross-OS C++ build tool with <strong>CMake</strong>.
          </p>

          <p className="mt-12">
            I am very fortunate that I chose coding as my hobby &amp; career
            too. It feels so grateful to think that things I learned and did for
            fun in college is now my profession. I&apos;m the type of person who
            keep awake late night to fix a bug. I&apos;m also interested in{" "}
            <strong>machine learning</strong>.
          </p>

          <p className="mt-12">
            Alongside coding I love to read story books, watching crime thriller
            movies and TV series. When not doing anything, I sleep. I sleep a
            lot.
          </p>
        ...
        <div className="w-full flex flex-col column justify-center items-center mt-16">
          ...
          <div className="max-w-6xl w-full sm:flex shadow-lg">
            ...
            >
              <ul className="list-disc list-inside text-3xl flex justify-around font-mono">
                <div>
